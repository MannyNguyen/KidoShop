...
public class ChildMessageAdapter extends RecyclerView.Adapter<ChildMessageAdapter.MyViewHolder> {

    Fragment fragment;
    RecyclerView recyclerView;
    List<BeanMessage.BeanChildMessage> childMessages;

    public ChildMessageAdapter(Fragment fragment, RecyclerView recyclerView, List<BeanMessage.BeanChildMessage> childMessages) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_message_child, parent, false);
