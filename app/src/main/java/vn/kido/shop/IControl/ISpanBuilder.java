...
public class ISpanBuilder {
    ...
    public ISpanBuilder append(String text, CharacterStyle... styles) {
    ...
    public ISpanBuilder appendWithSpace(String text, CharacterStyle... styles) {
        return append(text.concat(" "), styles);
    }

    public ISpanBuilder appendWithLineBreak(String text, CharacterStyle... styles) {
